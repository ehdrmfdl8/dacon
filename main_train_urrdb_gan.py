        ...
        for i, train_data in enumerate(train_loader):
            ...
            if current_step % opt['train']['checkpoint_test'] == 0 and opt['rank'] == 0:
                ...
                for test_data in test_loader:
                    ...
                    logger.info('{:->4d}--> {:>10s} | {:<4.2f}dB | {:.4f}'.format(idx, image_name_ext, current_psnr, current_ssim))
                ...
                # testing log
                logger.info(
                    '<epoch:{:3d}, iter:{:8,d}, Average PSNR : {:<.2f}dB, Average SSIM : {:.4f}\n'.format(epoch, current_step, avg_psnr, avg_ssim))
                # average 10 psnr
            ...
            if current_step % opt['train']['checkpoint_save'] == 0 and opt['rank'] == 0:
                ...
                if best_psnr[0] == avg_psnr:
                    ...
                    logger.info('save best PSNR model : {:<.2f}dB | {:}_G.pth\n'.format(best_psnr[0], best_current_step))
                else:
